...
public:
    ...
    BinaryTree* getLeftChild(void);  
    BinaryTree* getRightChild(void);    
    BinaryTree* getParent(void); 
    T getData(void);
    void setData(T item);
    void setLeft(BinaryTree* tree);
    void setRight(BinaryTree* tree);
    void infix(void);              
    void prefix(void);         
 ...
 ***********************************************************************/
template < class T >
List < T > ::List(const List &listToCopy)  
{
    numItems = 0;
 ...
 **********************************************************************/
template < class T >
void BinaryTree < T > ::insertLeft(T item)
{
 ...
 **********************************************************************/
template < class T >
void BinaryTree < T > ::insertRight(T item)
{
 ...
 **********************************************************************/
template < class T >
BinaryTree < T > * BinaryTree < T > ::getLeftChild(void)
{
    return left;
}
 ...
 **********************************************************************/
template < class T >
BinaryTree < T > * BinaryTree < T > ::getRightChild(void)
{
    return right;
}
 ...
 **********************************************************************/
template < class T >
BinaryTree < T > * BinaryTree < T > ::getParent(void)
{
    return parent;
}
 ...
 **********************************************************************/
template < class T >
void BinaryTree < T > ::setData(T item)
{
    data = item;
}
 ...
 **********************************************************************/
template < class T >
void BinaryTree < T > ::buildTree(int childId, int husId, int wifeId,
                             List < T > &family)
{
 ...
 **********************************************************************/
template < class T >
void BinaryTree < T > ::postfix(void)
{
    if (left != NULL)
        left->postfix();
    if (right != NULL)
...
void parseFamily(ifstream &fin, List < Person > &family,
                 BinaryTree < Person > &familyTree, string &next);
